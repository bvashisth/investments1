  ...
  return (
    <div className="container mx-auto px-4 py-8 pt-20">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="mb-6">
            At SparcoDB, we understand that businesses need flexible financing solutions to thrive and expand. Our
      ...
      <Card>
        ...
        <CardContent>
          <div className="space-y-4">
            <p>
              To apply for a Commercial Loan, you'll need to have a Business Account with SparcoDB. This allows us to:
            </p>
        ...
        <CardFooter className="flex flex-col sm:flex-row gap-4">
          ...
          <Button asChild variant="outline" className="w-full sm:w-auto">
            <Link href="/login/business">Login to Your Business Account</Link>
          </Button>
        </CardFooter>
      </Card>
    </div>
