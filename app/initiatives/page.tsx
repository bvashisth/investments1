          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              ...
              <InitiativePopup
                ...
                description="At Fiblimited Bank, we understand that one size doesn't fit all when it comes to financial services. Our Tailored Financial Products initiative is built on the principle that every individual and business has unique financial needs and aspirations. We've moved beyond the traditional banking model to create a suite of customizable products that adapt to the diverse requirements of our global customer base.
          ...
          <Card className="bg-white shadow-lg">
            ...
            <CardContent>
              ...
              <InitiativePopup
                ...
                description="Fiblimited Bank's Financial Education initiative is founded on the belief that knowledge is the most powerful tool for financial empowerment. We're committed to breaking down the complexities of finance and making this knowledge accessible to all, regardless of their background or current financial status.
