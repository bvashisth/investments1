  ...
  return (
    <div className="container mx-auto px-4 py-8 pt-20">
      ...
      <Card className="mb-8">
        ...
        <CardContent>
          <p className="mb-4">
            SparcoDB is a forward-thinking financial institution based in Malaysia, dedicated to bridging the gap in
            financial inclusion worldwide. Our mission is to empower underbanked and unbanked communities by offering
            innovative, affordable, and accessible financial solutions. Through our tailored services, strategic
            investments, and partnerships, we aim to foster economic growth, uplift local economies, and create
            sustainable opportunities for individuals and businesses globally.
          </p>
      ...
      <div className="grid md:grid-cols-2 gap-6 mb-8">
        ...
        <Card>
          ...
          <CardContent>
            <p>
              FINTECH BANK LTD. develops customized solutions such as microloans, savings programs, and affordable
      ...
      <Card>
        ...
        <CardContent>
          <p className="mb-4">
            At SparcoDB, we are driven by a passion for creating meaningful impact. We aim to achieve the United Nations
            Sustainable Development Goals (SDGs) by promoting financial inclusion, fostering entrepreneurship, and
            supporting sustainable community growth.
          </p>
          <p className="mb-4">
            Through technology, innovation, and collaboration, SparcoDB is shaping a future where financial services are
            accessible to all, empowering individuals and businesses to reach their full potential.
          </p>
          <p className="font-semibold">SparcoDB: Expanding Opportunities, Transforming Lives.</p>
        </CardContent>
      </Card>
    </div>
  )
