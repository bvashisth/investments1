  ...
  return (
    <div className="container mx-auto px-4 py-8 pt-20">
      ...
      <p className="text-center text-lg mb-12 text-[#4a5d7a] max-w-3xl mx-auto">
        Meet the visionaries behind SparcoDB who are dedicated to revolutionizing financial inclusion and making banking
        accessible to all.
      </p>
        ...
        <Card className="bg-white">
          ...
          <CardContent>
            <div className="space-y-4">
              ...
              <p className="text-sm text-[#4a5d7a]">
                His vision and leadership are pivotal in driving SparcoDB's mission of financial inclusion, ensuring
                that our services reach those who need them most while maintaining sustainable growth and impact.
              </p>
              <div className="pt-4">
                <Link href="#" className="text-[#3b82f6] hover:text-[#2563eb] inline-flex items-center">
                  <LinkedinIcon className="h-5 w-5 mr-2" />
          ...
          <CardContent>
            <div className="space-y-4">
              <p className="text-sm text-[#4a5d7a]">
                ...
                expansion capabilities of SparcoDB. His innovative approaches to trading, especially in crude oil and
