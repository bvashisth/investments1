      ...
      <DialogContent className="sm:max-w-[600px] max-h-[80vh] overflow-y-auto">
        <DialogHeader>
          ...
          <DialogDescription className="text-[#4a4749]">
            At SparcoDB, our mission transcends borders. We are dedicated to serving diverse communities across
        ...
        <div className="grid gap-6 py-4">
          ...
          <div className="flex items-start gap-4">
            ...
            <div>
              ...
              <p className="text-sm text-[#4a4749]">
                From rural villages to bustling urban centers, Fiblimited is committed to uplifting local economies. By
        ...
        <div className="mt-6">
          <h3 className="font-bold text-[#2d2a2e] text-xl mb-2">SparcoDB: Financial Solutions Beyond Borders</h3>
