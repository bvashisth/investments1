      ...
      <div className="container mx-auto px-4 py-12">
        <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/business" className="text-sm text-[#4a5d7a] hover:text-[#3b82f6]">
                  Business Banking
                </Link>
              </li>
              <li>
                <Link href="/personal" className="text-sm text-[#4a5d7a] hover:text-[#3b82f6]">
                  Personal Banking
                </Link>
              </li>
              <li>
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link
                  href="https://support.fiblimited.com"
              ...
              <li>
                <a href="mailto:support@fiblimited.com" className="text-sm text-[#4a5d7a] hover:text-[#3b82f6]">
                  Contact Us
                </a>
              </li>
            </ul>
        ...
        <div className="mt-12 pt-8 border-t border-[#3b82f6]/20 text-center text-sm text-[#4a5d7a]">
          <p>&copy; {new Date().getFullYear()} SparcoDB. All rights reserved.</p>
